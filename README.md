...
> Mega audit all links in an html file

[![PyPI version](https://badge.fury.io/py/mega-link-audit.svg)](https://pypi.org/project/mega-link-audit/)
...
```bash
pip install mega-link-audit
```

## Quick Start

```python
from mega_link_audit import audit
...
from mega_link_audit import batch
